...
export const ProfileCompletionModal: React.FC<ProfileCompletionModalProps> = ({
  ...
  const updateProfileMutation = useMutation({
    ...
    onSuccess: (response) => {
      ...
      const isUnapprovedAgent =
        userRole === "agent" && updatedUser.approved !== true;
  ...
  return (
    <>
          ...
          <div className="overflow-y-auto max-h-[80vh] sm:max-h-[85vh] px-4 sm:px-6 py-4 pb-6">
            <DialogHeader className="space-y-2">
              ...
              <DialogDescription className="text-sm sm:text-base text-center sm:text-left">
                Help us personalize your real estate experience
              </DialogDescription>
            </DialogHeader>
                      ...
                      <FormControl>
                        <div className="relative">
                          ...
                          <input
                            ...
                            className="w-full h-10 sm:h-11 pl-10 pr-3 py-2.5 border-2 rounded-lg text-sm sm:text-base focus:outline-none focus:border-blue-600"
                          />
                        </div>
                      </FormControl>
                    ...
                    <div>
                      ...
                      {categoriesLoading ? (
                        ...
                        <Popover>
                          ...
                          >
                            <div
                              className="max-h-[200px] overflow-y-scroll p-2"
      ...
      <Dialog open={showConfirmDialog} onOpenChange={setShowConfirmDialog}>
        <DialogContent className="!w-[60vw] !max-w-[320px] mx-auto p-4">
          <DialogHeader className="space-y-3">
            <DialogTitle className="text-lg font-bold text-center">
              Cancel Profile Completion?
            </DialogTitle>
            <DialogDescription className="text-sm text-center text-gray-600">
              Are you sure you want to cancel? You will be logged out and need
              to login again.
            </DialogDescription>
          </DialogHeader>
