    ...
    return (
      <div className="min-h-screen pb-8 px-4 sm:px-6 lg:px-8">
        <div className="bg-card/95 backdrop-blur-sm flex items-center justify-between px-4 sm:px-6 pt-4 pb-3 shadow-lg border-b border-border/50 sticky top-0 z-20 mb-3">
          ...
          <h1 className="flex-1 text-center text-lg sm:text-xl font-bold text-foreground">Banner Management</h1>
      ...
      <div className="min-h-screen pb-8 flex items-center justify-center px-4">
        <div className="max-w-md w-full bg-card rounded-2xl shadow-lg border border-border p-8 text-center animate-in fade-in zoom-in-95 duration-300">
          ...
          <p className="text-sm sm:text-base text-muted-foreground mb-6 leading-relaxed">
            Unable to fetch banner statistics. Please check your connection and try again.
          </p>
          <button
            onClick={() => refetch()}
